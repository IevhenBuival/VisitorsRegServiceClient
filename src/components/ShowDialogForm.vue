<template>
    <section class="signup-view">
      <form @submit.prevent class="ui form "  novalidate >
        ...
        <ShowDialogInput :label="'surname'" :name="'surname'" v-model="dialog.surname" />
        <button :disabled="isSignupButtonDisabled" class="ui button red fluid big" @click="signUpButtonPressed">
    OK
</button>
      </form>
    </section>
